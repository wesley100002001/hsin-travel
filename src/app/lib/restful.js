...
export function getMockRequests () {
  return new Promise(function (resolve, reject) {
    var requests = [
      { requestId: 'A001', title: '北台灣五天四夜', company: 'JTB中部 岡崎支店', startTime: '2016/08/09', endTime: '2016/08/13', requester: 'Wesley', createTime: '2016/08/10' },
      { requestId: 'A002', title: '南台灣四天三夜', company: 'JTB中部 岡崎支店', startTime: '2016/09/20', endTime: '2016/09/23', requester: 'Christine', createTime: '2016/08/11' },
      { requestId: 'A003', title: '北台灣五天四夜', company: 'JTB中部 岡崎支店', startTime: '2016/08/09', endTime: '2016/08/13', requester: 'Christine', createTime: '2016/08/13' },
      { requestId: 'A004', title: '南台灣四天三夜', company: 'JTB中部 岡崎支店', startTime: '2016/09/20', endTime: '2016/09/23', requester: 'Christine', createTime: '2016/08/13' },
      { requestId: 'A005', title: '北台灣五天四夜', company: 'JTB中部 岡崎支店', startTime: '2016/08/09', endTime: '2016/08/13', requester: 'Wesley', createTime: '2016/08/16' },
      { requestId: 'A006', title: '南台灣四天三夜', company: 'JTB中部 岡崎支店', startTime: '2016/09/20', endTime: '2016/09/23', requester: 'Kevin', createTime: '2016/08/17' },
      { requestId: 'A007', title: '北台灣五天四夜', company: 'JTB中部 岡崎支店', startTime: '2016/08/09', endTime: '2016/08/13', requester: 'Wesley', createTime: '2016/08/21' },
      { requestId: 'A008', title: '南台灣四天三夜', company: 'JTB中部 岡崎支店', startTime: '2016/09/20', endTime: '2016/09/23', requester: 'Kevin', createTime: '2016/08/22' },
      { requestId: 'A009', title: '北台灣五天四夜', company: 'JTB中部 岡崎支店', startTime: '2016/08/09', endTime: '2016/08/13', requester: 'Wesley', createTime: '2016/08/23' },
      { requestId: 'A010', title: '南台灣四天三夜', company: 'JTB中部 岡崎支店', startTime: '2016/09/20', endTime: '2016/09/23', requester: 'John', createTime: '2016/08/29' }
    ];
    resolve(requests);
  });
}
